...
public class ProductRequest {
    ...
    // Defaults to BOOK in the entity if omitted - kept optional here (unlike
    // isRentable/isLibraryEligible) so existing callers/imports predating
    // this field don't start failing validation.
    private com.bookworm.backend.entity.Product.MediaType mediaType;

    // Only meaningful when mediaType = PODCAST.
