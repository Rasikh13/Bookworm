...
class ProductServiceImplTest {
    ...
    @Mock private com.bookworm.backend.repository.ProductTranslationRepository productTranslationRepository;
    ...
    void setUp() {
        service = new ProductServiceImpl(productRepository, subcategoryRepository, genreRepository,
                ...
                productBeneficiaryService, productTranslationRepository, auditService, productMapper);
